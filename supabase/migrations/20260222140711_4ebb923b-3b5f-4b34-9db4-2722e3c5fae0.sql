...
CREATE TABLE public.analyses (
  ...
  opponent_type TEXT,
  financial_loss TEXT,
  evidence_contract BOOLEAN NOT NULL DEFAULT false,
  evidence_payment BOOLEAN NOT NULL DEFAULT false,
  evidence_communication BOOLEAN NOT NULL DEFAULT false,
  clerk_summary TEXT,
  devil_analysis TEXT,
  strategist_output TEXT,
  legal_strength_score INTEGER DEFAULT 0,
